...
- Backend tests: **686 passing** (only ratchets up; +11 for Click/Type round-trip + the post-click-URL host gate, on top of r32's +13). Frontend gated by `node --check` + live Electron screenshot-verify.
