...
class ScoreCard(BaseTool):
    ...
    dimension can never pass, and the scorecard shows it as "not scored". Use this
    as the last step of a review, after loading the brief with ReadBrief and
    checking the deliverable against goal / must_include / must_avoid /
    done_criteria.
    """
    ...
    def run(self) -> str:
        verdict = verdict_from_scores(self.scores)
